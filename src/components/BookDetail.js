    ...
    const detailRecommendations = book.recommendations.map(recommendation => {
        return (
            <div className="detail-recommendation">
                <h3>Here's why <strong>{recommendation.user}</strong> recommends this book:</h3>
        ...
        <Container id="book-detail">
            <Row>
                ...
                <Col id="detail-info">
                    ...
                    <p id="detail-author"><em>by</em> {book.author}</p>
                    <p id="detail-description">{book.description}</p>
                    <p id="detail-isbn"><strong>ISBN:</strong> {book.isbn}</p>
