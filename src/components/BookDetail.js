...
import { emptyBooks } from "../actions/index";
...
class BookDetail extends Component {
  ...
  detailTags() {
    const bookRecommendations = this.props.allRecommendations.filter(
      (recommendation) => {
    ...
    return (
      <Row>
        ...
        <Col lg={6} id="detail-info">
          {/* Back button */}
          <Link to="/" onClick={this.props.emptyBooks}>
            Back
          </Link>
          ...
          <Container id="book-detail">
            ...
            <Row>
              <Col>
                ...
                <div
                  id="recommendation-form-container"
                  className={this.showFormContainer()}>
                  <RecommendationForm />
                </div>
...
function mapDispatchToProps(dispatch) {
  return bindActionCreators({ searchBook, emptyBooks }, dispatch);
}
